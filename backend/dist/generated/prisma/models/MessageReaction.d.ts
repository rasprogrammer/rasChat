...
export type GetMessageReactionGroupByPayload<T extends MessageReactionGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<MessageReactionGroupByOutputType, T['by']> & {
...
export type MessageReactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "messageId" | "userId" | "emoji", ExtArgs["result"]["messageReaction"]>;
